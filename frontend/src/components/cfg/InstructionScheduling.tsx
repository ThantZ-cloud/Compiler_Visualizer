...
const InstructionScheduling: React.FC<InstructionSchedulingProps> = ({ method, instructions, scheduling, isPlaying, isCompleted }) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center justify-between gap-2 px-1">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <h4 className="text-[11px] font-bold text-[var(--color-text)] font-display tracking-[0.1em] uppercase m-0">
            {t('optimizer.step5.title', 'Instruction Scheduling')}
          </h4>
          {method && (
      ...
      <p className="text-[10px] text-[var(--color-text-dim)] font-mono px-1 -mt-1">
        {t('optimizer.step5.description', 'List scheduling reorders instructions to minimize pipeline stalls while preserving data dependencies. Each node is one instruction; edges are the dependencies that constrain the order.')}
      </p>
