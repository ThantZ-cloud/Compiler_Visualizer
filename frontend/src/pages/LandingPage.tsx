    ...
    <div className="flex flex-col min-h-screen bg-[var(--color-void)]">
      ...
      >
        ...
        <section className="relative flex items-center min-h-[calc(100dvh-3.5rem)] overflow-hidden">
          ...
          <div className="hidden sm:block absolute top-3 left-3 w-8 h-8 md:top-10 md:left-10 md:w-16 md:h-16 border-t-2 border-l-2 border-[var(--color-neon)] neon-corner opacity-30 z-10" />
          <div className="hidden sm:block absolute top-3 right-3 w-8 h-8 md:top-10 md:right-10 md:w-16 md:h-16 border-t-2 border-r-2 border-[var(--color-neon)] neon-corner opacity-30 z-10" />
          <div className="hidden sm:block absolute bottom-3 left-3 w-8 h-8 md:bottom-10 md:left-10 md:w-16 md:h-16 border-b-2 border-l-2 border-[var(--color-neon)] neon-corner opacity-30 z-10" />
          <div className="hidden sm:block absolute bottom-3 right-3 w-8 h-8 md:bottom-10 md:right-10 md:w-16 md:h-16 border-b-2 border-r-2 border-[var(--color-neon)] neon-corner opacity-30 z-10" />
