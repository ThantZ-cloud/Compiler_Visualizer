...
function MiniCompilerBox() {
  ...
  return (
    <div className="relative rounded-lg border border-[var(--color-border)] bg-[var(--color-void)] overflow-hidden flex flex-col h-[170px] shrink-0 w-full">
...
function MiniLearnBox() {
  ...
  return (
    <div className="relative rounded-lg border border-[var(--color-border)] bg-[var(--color-void)] overflow-hidden flex flex-col h-[170px] shrink-0 p-3">
    ...
    <div className="flex flex-col min-h-screen bg-[var(--color-void)]">
      ...
      >
        ...
        <section className="relative flex items-center min-h-[calc(100dvh-3.5rem)] overflow-hidden">
          ...
          <div className="hidden md:block absolute top-6 left-6 w-16 h-16 border-t-2 border-l-2 border-[var(--color-neon)] neon-corner opacity-40 z-10 pointer-events-none" />
          <div className="hidden md:block absolute top-6 right-6 w-16 h-16 border-t-2 border-r-2 border-[var(--color-neon)] neon-corner opacity-40 z-10 pointer-events-none" />
          <div className="hidden md:block absolute bottom-6 left-6 w-16 h-16 border-b-2 border-l-2 border-[var(--color-neon)] neon-corner opacity-40 z-10 pointer-events-none" />
          <div className="hidden md:block absolute bottom-6 right-6 w-16 h-16 border-b-2 border-r-2 border-[var(--color-neon)] neon-corner opacity-40 z-10 pointer-events-none" />
